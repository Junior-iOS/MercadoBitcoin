...
private struct _PlistKeyedEncodingContainer<K: CodingKey>: KeyedEncodingContainerProtocol {
    ...
    mutating func encodeNil(forKey key: Key)               throws { self.container[key.stringValue] = _plistNullNSString }
    ...
    mutating func superEncoder() -> Encoder {
        _PlistReferencingEncoder(referencing: self.encoder, at: _PlistKey.super, wrapping: self.container)
    }
...
private struct _PlistUnkeyedEncodingContainer: UnkeyedEncodingContainer {
    ...
    mutating func encodeNil()             throws { self.container.add(_plistNullNSString) }
    ...
    mutating func nestedUnkeyedContainer() -> UnkeyedEncodingContainer {
        ...
        return Self(referencing: self.encoder, codingPath: self.codingPath, wrapping: array)
    }

    mutating func superEncoder() -> Encoder {
        _PlistReferencingEncoder(referencing: self.encoder, at: self.container.count, wrapping: self.container)
    }
}
...
private struct _PlistUnkeyedDecodingContainer: UnkeyedDecodingContainer {
    ...
    mutating func nestedUnkeyedContainer() throws -> UnkeyedDecodingContainer {
        ...
        self.currentIndex += 1
        return Self(referencing: self.decoder, wrapping: array)
    }
...
private struct _PlistKey: CodingKey {
    ...
    fileprivate static let `super` = Self(stringValue: "super")!
}
