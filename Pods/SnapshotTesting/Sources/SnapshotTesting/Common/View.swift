...
public struct ViewImageConfig {
  ...
  #if os(iOS)
  public static let iPhoneSe = Self.iPhoneSe(.portrait)

  public static func iPhoneSe(_ orientation: Orientation) -> Self {
  ...
  public static let iPhone8 = Self.iPhone8(.portrait)

  public static func iPhone8(_ orientation: Orientation) -> Self {
    let safeArea: UIEdgeInsets
    let size: CGSize
    switch orientation {
    case .landscape:
  ...
  public static let iPhone8Plus = Self.iPhone8Plus(.portrait)

  public static func iPhone8Plus(_ orientation: Orientation) -> Self {
    let safeArea: UIEdgeInsets
    let size: CGSize
    switch orientation {
    case .landscape:
  ...
  public static let iPhoneX = Self.iPhoneX(.portrait)

  public static func iPhoneX(_ orientation: Orientation) -> Self {
    let safeArea: UIEdgeInsets
    let size: CGSize
    switch orientation {
    case .landscape:
  ...
  public static let iPhoneXsMax = Self.iPhoneXsMax(.portrait)

  public static func iPhoneXsMax(_ orientation: Orientation) -> Self {
    let safeArea: UIEdgeInsets
    let size: CGSize
    switch orientation {
    case .landscape:
  ...
  @available(iOS 11.0, *)
  public static let iPhoneXr = Self.iPhoneXr(.portrait)

  @available(iOS 11.0, *)
  public static func iPhoneXr(_ orientation: Orientation) -> Self {
    let safeArea: UIEdgeInsets
    let size: CGSize
    switch orientation {
    case .landscape:
  ...
  public static let iPadMini = Self.iPadMini(.landscape)

  public static func iPadMini(_ orientation: Orientation) -> Self {
    switch orientation {
    case .landscape:
      return Self.iPadMini(.landscape(splitView: .full))

    case .portrait:
      return Self.iPadMini(.portrait(splitView: .full))
    }
  }

  public static func iPadMini(_ orientation: TabletOrientation) -> Self {
    let size: CGSize
    ...
    case .portrait(let splitView):
      switch splitView {
      case .oneThird:
        size = .init(width: 320, height: 1_024)
        traits = .iPadMini_Compact_SplitView

      case .twoThirds:
        size = .init(width: 438, height: 1_024)
        traits = .iPadMini_Compact_SplitView
  ...
  public static let iPadPro10_5 = Self.iPadPro10_5(.landscape)

  public static func iPadPro10_5(_ orientation: Orientation) -> Self {
    switch orientation {
    case .landscape:
      return Self.iPadPro10_5(.landscape(splitView: .full))

    case .portrait:
      return Self.iPadPro10_5(.portrait(splitView: .full))
    }
  }

  public static func iPadPro10_5(_ orientation: TabletOrientation) -> Self {
    let size: CGSize
    let traits: UITraitCollection
    switch orientation {
    case .landscape(let splitView):
      ...
      case .full:
        size = .init(width: 1_112, height: 834)
        traits = .iPadPro10_5
      }
    ...
    case .portrait(let splitView):
      switch splitView {
      case .oneThird:
        size = .init(width: 320, height: 1_112)
        traits = .iPadPro10_5_Compact_SplitView

      case .twoThirds:
        size = .init(width: 504, height: 1_112)
        traits = .iPadPro10_5_Compact_SplitView

      case .full:
        size = .init(width: 834, height: 1_112)
        traits = .iPadPro10_5
      }
    }
    return .init(safeArea: .init(top: 20, left: 0, bottom: 0, right: 0), size: size, traits: traits)
  ...
  public static let iPadPro11 = Self.iPadPro11(.landscape)

  public static func iPadPro11(_ orientation: Orientation) -> Self {
    switch orientation {
    case .landscape:
      return Self.iPadPro11(.landscape(splitView: .full))

    case .portrait:
      return Self.iPadPro11(.portrait(splitView: .full))
    }
  }

  public static func iPadPro11(_ orientation: TabletOrientation) -> Self {
    let size: CGSize
    let traits: UITraitCollection
    switch orientation {
    case .landscape(let splitView):
      ...
      case .full:
        size = .init(width: 1_194, height: 834)
        traits = .iPadPro11
      }
    ...
    case .portrait(let splitView):
      switch splitView {
      case .oneThird:
        size = .init(width: 320, height: 1_194)
        traits = .iPadPro11_Compact_SplitView

      case .twoThirds:
        size = .init(width: 504, height: 1_194)
        traits = .iPadPro11_Compact_SplitView

      case .full:
        size = .init(width: 834, height: 1_194)
        traits = .iPadPro11
      }
    }
  ...
  public static let iPadPro12_9 = Self.iPadPro12_9(.landscape)

  public static func iPadPro12_9(_ orientation: Orientation) -> Self {
    switch orientation {
    case .landscape:
      return Self.iPadPro12_9(.landscape(splitView: .full))

    case .portrait:
      return Self.iPadPro12_9(.portrait(splitView: .full))
    }
  }

  public static func iPadPro12_9(_ orientation: TabletOrientation) -> Self {
    let size: CGSize
    let traits: UITraitCollection
    switch orientation {
    case .landscape(let splitView):
      switch splitView {
      case .oneThird:
        size = .init(width: 375, height: 1_024)
        traits = .iPadPro12_9_Compact_SplitView

      case .oneHalf:
        size = .init(width: 678, height: 1_024)
        traits = .iPadPro12_9

      case .twoThirds:
        size = .init(width: 981, height: 1_024)
        traits = .iPadPro12_9
    ...
    case .portrait(let splitView):
      switch splitView {
      case .oneThird:
        size = .init(width: 375, height: 1_366)
        traits = .iPadPro12_9_Compact_SplitView

      case .twoThirds:
        size = .init(width: 639, height: 1_366)
        traits = .iPadPro12_9_Compact_SplitView
  ...
  #elseif os(tvOS)
  public static let tv = Self(
    safeArea: .init(top: 60, left: 90, bottom: 60, right: 90),
    size: .init(width: 1_920, height: 1_080),
    traits: .init()
  )
  public static let tv4K = Self(
    safeArea: .init(top: 120, left: 180, bottom: 120, right: 180),
    size: .init(width: 3_840, height: 2_160),
    traits: .init()
  )
  #endif
}
